...
api.get('/get_list_by_item/:item_id', md_auth.ensureAuth, PresentacionItemController.getListByItem);
...
api.post('/upload_image/:id', [md_auth.ensureAuth, md_upload], PresentacionItemController.uploadImage);
api.get('/get_image/:imageFile', PresentacionItemController.getImageFile);
